...
<div class="sidebar mt-3 sidebar-content_Book" id="Book">
    ...
    <div class="sidebar-content">
        ...
        <div class="extra-nav ">
            <a href="./booking.html" class="theme-btn">
                Book & Pay Now
            </a>
            ...
            <div class="row">
                ...
                <div class="col-lg-12 ">
                    <div
                        class="tour-details-package-box position-relative d-flex align-items-center justify-content-between mt-3">
                        <label>Date</label>
                        <input type="text" name="datetime-local" class="flatpickr-input"
                            placeholder="Select Date" readonly="readonly">
                    </div>
                </div>
                <div class="col-lg-4 col-6">
                    <div class="adult-counter">
                        ...
                        <div class="counter-controls">
                            ...
                            <input type="number" name="adults" data-type="adults" min="0" value="0"
                                data-price="1" class="quantity-input">
                            <button type="button" class="increase-btn" data-target="adults">+</button>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-6">
                    <div class="adult-counter">
                        ...
                        <div class="counter-controls">
                            ...
                            <input type="number" name="children" data-type="Children" min="0"
