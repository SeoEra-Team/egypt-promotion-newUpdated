...
<div class="contact-floatbox d-none d-sm-block">
    <a href="https://api.whatsapp.com/send/?phone={{ nova_get_setting('site_whatsapp') }}&amp;text=i+found+your+No+on+website&amp;type=phone_number&amp;app_absent=0"
        ...
        <img src="https://new.golavitatravel.com/assets/images/whatsapp.svg" alt="whatsapp-icon" title="whatsapp-icon" width="50" height="50">
    </a>
    <a href="tel:{{ nova_get_setting('site_phone') }}" target="_blank" data-bs-toggle="tooltip" data-bs-placement="top" title="phone-call"
        class="phone_call">
        <img loading="lazy" src="https://new.golavitatravel.com/assets/images/call.png" alt="phone_call"
            title="  phone_call" width="50" height="50" >
    </a>
</div>
