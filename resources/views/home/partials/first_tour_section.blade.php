<section class="second-tours Popular-Tours padtobo-60 pt-2">
    <div class="container">
        ...
        <div class="second-tours-sliders">
            <div class="swiper second-tours-swiper">
                        ...
                        <div class="swiper-slide">
                            <div class="swiper-slide-img">
                                <a href="{{ route('tour.show', ['categorySlug' => $tour->category->category->slug, 'subCategorySlug' => $tour->category->slug, 'tourSlug' => $tour->slug]) }}">
                                    <img loading="lazy"
                                        src="{{ $tour->getFirstMediaUrlOrDefault(App\Helpers\Constants\MediaHelper::TOUR_MEDIA_PATH, 'webp')['url'] }}"
                                        alt="Family Trip for Three Days in Cairo"
                                        title="Family Trip for Three Days in Cairo">
                                ...
                                <div class="heart-icon wishlist-icon">
                                    <a class="addfavorite" data-href="{{ route('favorite.add', $tour->id) }}"
                                ...
                                <div class="swiper-slide-content">
                                    ...
                                    <div class="second-tour-info">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between">
                                            <span class="second-tour-price">
                                                <span class="tour-footer-price">
                                                    {{ App\Helpers\Classes\Currency::display($tour->final_price) }}
                                                </span>
                                                / {{ __('general.person') }}
                                            </span>
                                            <a class="show-more" href="{{ route('tour.show', ['categorySlug' => $tour->category->category->slug, 'subCategorySlug' => $tour->category->slug, 'tourSlug' => $tour->slug]) }}" target="_blank">
